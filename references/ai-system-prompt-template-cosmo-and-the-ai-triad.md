...
For the AI Triad architecture, see [architecture.md § The AI Triad](https://github.com/opencosmos-ai/opencosmos/blob/main/docs/architecture.md#the-ai-triad). For each voice's current system prompt, see [packages/ai/triad/](https://github.com/opencosmos-ai/cosmo/tree/main/triad/).
