---
title: "The Self — Cross-Tradition Synthesis"
role: wiki
domain: cross
confidence: medium
status: active
synthesizes:
  ...
  - sources/philosophy-the-ethics.md
...
contradictions:
  - Buddhist Dhammapada teaches liberation through non-attachment to self; Plato's Phaedo argues the soul's immortality is the ground for philosophical life — attachment to the soul (properly understood) is essential
  - Heart Sutra says "no eyes, no ears, no nose...no mind" — a radical negation of selfhood; Plato says the soul is the *real* self and the body is secondary
  - Nietzsche's "no being behind doing" (the unified self is a grammatical fiction) converges with Buddhist anatman in denying a permanent self — but Nietzsche's will to power presupposes an agent that strives and overcomes; the denial and the affirmation coexist in tension
  - The Bhagavad-Gita's atman (eternal, indestructible individual soul) is in direct metaphysical opposition to Buddhist anatman (no permanent self) — both are Indian philosophical traditions using different responses to the same question
---
