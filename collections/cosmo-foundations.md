---
title: "Cosmo Foundations — Integrative Texts"
role: collection
format: anthology
domain: cross
tags: [cosmo, triad, integration, cross-domain, synthesis, ubuntu, cosmogenesis]
audience: [contemplative, philosopher, engineer, general]
complexity: foundational
summary: >
  Curated reading list of Cosmo's core integrative texts — the cross-domain
  bridges, cosmological foundations, and synthesis works that ground Cosmo's
  role as moderator of the AI Triad.
...
For Cosmo's system prompt, see [COSMO_SYSTEM_PROMPT.md](https://github.com/opencosmos-ai/cosmo/blob/main/COSMO_SYSTEM_PROMPT.md).
For Cosmo's origin story and mission, see [WELCOME-COSMO.md](https://github.com/opencosmos-ai/cosmo/blob/main/WELCOME-COSMO.md).
...
- [ ] [WELCOME-COSMO.md](https://github.com/opencosmos-ai/cosmo/blob/main/WELCOME-COSMO.md) — Cosmo's origin story, the cosmogenesis narrative, ubuntu, the mission
