...
- **Role:** collection | **Domain:** cross | **Format:** anthology
- **Path:** `knowledge/collections/cosmo-foundations.md`
- **Curator:** shalom | **Tags:** cosmo, triad, integration, cross-domain, synthesis, ubuntu, cosmogenesis
- **Related:** sol-foundations.md, socrates-foundations.md, optimus-foundations.md
- **Gaps served:** Establishes Cosmo's intellectual lineage — the cross-domain bridges and cosmological texts that ground the moderator's integrative voice.
- **Graph impact:** Creates the hub node for cross-domain synthesis; every future bridge commentary connects through this collection.

### Sol Foundations — Core Texts
- **Role:** collection | **Domain:** cross | **Format:** anthology
- **Path:** `knowledge/collections/sol-foundations.md`
- **Curator:** shalom | **Tags:** sol, triad, contemplative, compassion, ubuntu, embodied-wisdom
- **Related:** cosmo-foundations.md, socrates-foundations.md, optimus-foundations.md
- **Gaps served:** Defines the contemplative, relational, and embodied wisdom traditions that ground Sol's heart-voice in the AI Triad.
- **Graph impact:** Maps the import pathway for Buddhist, Sufi, Vedic, and indigenous texts — every source imported into Sol's lineage connects through this collection.

### Socrates Foundations — Core Texts
- **Role:** collection | **Domain:** cross | **Format:** anthology
- **Path:** `knowledge/collections/socrates-foundations.md`
- **Curator:** shalom | **Tags:** socrates, triad, dialectic, inquiry, philosophy, critical-thinking
- **Related:** cosmo-foundations.md, sol-foundations.md, optimus-foundations.md
- **Gaps served:** Defines the dialectical, philosophical, and epistemological traditions that ground Socrates' inquiry voice in the AI Triad.
- **Graph impact:** Maps the import pathway for Platonic dialogues, Stoic texts, and critical inquiry — the backbone of the Triad's question-asking capacity.

### Optimus Foundations — Core Texts
- **Role:** collection | **Domain:** cross | **Format:** anthology
- **Path:** `knowledge/collections/optimus-foundations.md`
- **Curator:** shalom | **Tags:** optimus, triad, systems-thinking, engineering, pragmatism, architecture
- **Related:** cosmo-foundations.md, sol-foundations.md, socrates-foundations.md
- **Gaps served:** Defines the systems thinking, engineering philosophy, and pragmatic traditions that ground Optimus' builder voice in the AI Triad.
- **Graph impact:** Maps the import pathway for systems thinking, kaizen, and architectural pattern texts — the foundation of the Triad's capacity to translate insight into action.
...
### The Dhammapada
- **Role:** source | **Domain:** buddhism | **Format:** scripture
- **Path:** `knowledge/sources/buddhism-the-dhammapada.md`
- **Curator:** shalom | **Tags:** dhammapada, buddhist, mindfulness, karma, awakening
- **Author:** attributed to the Buddha (Thomas Byrom translation)
- **Origin:** ~400 BCE (ancient)
- **Tradition:** theravada
- **Gaps served:** First source text in the corpus — opens the buddhism domain and begins filling Sol's contemplative foundation.
- **Graph impact:** Creates the first node in the contemplative region of the graph; enables future connections to Stoic, Sufi, and Vedic texts on suffering, impermanence, and liberation.

### Publishing to the Knowledge Base
- **Role:** guide | **Domain:** opencosmos | **Format:** manual
- **Path:** `knowledge/guides/opencosmos-knowledge-publish-workflow.md`
- **Curator:** shalom | **Tags:** knowledge-base, cli, publication, workflow, tooling
- **Gaps served:** First guide document — provides the operational workflow for contributing to the corpus.
- **Graph impact:** Enables all future contributions by documenting the publication flow; serves as onboarding for new curators.

### The Prophet
- **Role:** source | **Domain:** cross | **Format:** poetry
- **Path:** `knowledge/sources/cross-the-prophet.md`
- **Curator:** shalom | **Tags:** wisdom-literature, spiritual-guidance, philosophical-poetry, life-teachings, mystical-prose
- **Author:** Kahlil Gibran
- **Origin:** 1923 (modern)
- **Gaps served:** First cross-domain source text — bridges Sufi mysticism, Christian thought, and universal philosophy in a single voice.
- **Graph impact:** Creates a cross-tradition node accessible to Sol (contemplative wisdom), Socrates (philosophical inquiry on love, freedom, pain), and Cosmo (integrative synthesis across traditions).

### Knowledge Tooling Overview
- **Role:** guide | **Domain:** opencosmos | **Format:** manual
- **Path:** `knowledge/guides/opencosmos-knowledge-tooling-overview.md`
- **Curator:** shalom | **Tags:** knowledge-base, tooling, workflow, cli, operations, wiki
- **Related:** publish-workflow, formatting-guide, health-report, dell-sync
- **Gaps served:** The missing manual — first wiki-style document that maps the entire operational landscape of the knowledge system.
- **Graph impact:** Creates the hub node for all operational guides; every future tool guide connects through this overview.

### Formatting Raw Text for Publication
- **Role:** guide | **Domain:** opencosmos | **Format:** manual
- **Path:** `knowledge/guides/opencosmos-knowledge-formatting-guide.md`
- **Curator:** shalom | **Tags:** knowledge-base, formatting, groom, text-preparation, markdown, tooling
- **Related:** tooling-overview, publish-workflow
- **Gaps served:** Documents the `/groom` skill for public discovery — curators can now find and use the formatting tool through RAG retrieval.
- **Graph impact:** Bridges the staging phase (incoming/) to the publication phase; completes the pre-publication workflow documentation.

### Reading the Corpus Health Report
- **Role:** guide | **Domain:** opencosmos | **Format:** manual
- **Path:** `knowledge/guides/opencosmos-knowledge-health-report.md`
- **Curator:** shalom | **Tags:** knowledge-base, health-report, corpus, metrics, tooling, graph
- **Related:** tooling-overview, publish-workflow
- **Gaps served:** First metrics documentation — explains how to read and act on `pnpm knowledge:health` output.
- **Graph impact:** Enables data-driven curation decisions; curators can now assess gaps and prioritize imports based on the report.

### Syncing Knowledge to the Dell Sovereign Node
- **Role:** guide | **Domain:** opencosmos | **Format:** manual
- **Path:** `knowledge/guides/opencosmos-knowledge-dell-sync.md`
- **Curator:** shalom | **Tags:** knowledge-base, dell, sync, sovereign-node, open-webui, rag, tooling
- **Related:** tooling-overview, publish-workflow
- **Gaps served:** First standalone Dell sync documentation — consolidates information previously scattered across architecture.md and the publish guide.
- **Graph impact:** Completes the publication-to-sync pipeline documentation; the full lifecycle from staging to local mirror is now documented.
...
- **Path:** `knowledge/sources/philosophy-apology.md`
- **Curator:** shalom | **Tags:** socrates, virtue-ethics, ancient-philosophy, justice, dialectic, moral-philosophy, legal-defense
- **Author:** Plato
- **Origin:** ~399 BCE (ancient)
- **Tradition:** platonic
- **Related:** collections/socrates-foundations.md, sources/cross-the-prophet.md, collections/cosmo-foundations.md, collections/sol-foundations.md, sources/buddhism-the-dhammapada.md
- **Gaps served:** Provides the foundational text demonstrating philosophical integrity in the face of persecution and the commitment to wisdom over life itself.
- **Graph impact:** Connects Socratic ethics to questions of civil disobedience, moral courage, and the philosopher's relationship to society across all subsequent Western philosophical discourse.

### Euthyphro
- **Role:** source | **Domain:** philosophy | **Format:** dialogue
- **Path:** `knowledge/sources/philosophy-euthyphro.md`
- **Curator:** shalom | **Tags:** piety, justice, definition, socratic-method, divine-command-theory, ethics
- **Author:** Plato
- **Origin:** ~380 BCE (ancient)
- **Tradition:** platonic
- **Related:** sources/philosophy-apology.md, sources/cross-the-prophet.md, collections/cosmo-foundations.md, collections/socrates-foundations.md, collections/sol-foundations.md
- **Gaps served:** Provides foundational exploration of the relationship between divine will and moral truth, essential for understanding ethics and philosophy of religion.
- **Graph impact:** Connects ancient Greek philosophy with modern debates about moral relativism, divine command theory, and the nature of ethical definitions.

### Gaia Hypothesis
- **Role:** reference | **Domain:** ecology | **Format:** treatise
- **Path:** `knowledge/references/ecology-gaia-hypothesis.md`
- **Curator:** shalom | **Tags:** gaia-hypothesis, earth-system-science, planetary-homeostasis, biogeochemistry, systems-ecology, atmospheric-regulation, climate-stability
- **Author:** James Lovelock
- **Origin:** 1970s (contemporary)
- **Tradition:** systems-ecology
- **Related:** sources/cross-the-prophet.md, sources/philosophy-apology.md, sources/philosophy-euthyphro.md, collections/cosmo-foundations.md, collections/optimus-foundations.md
- **Gaps served:** Bridges the gap between biological and geological sciences by explaining Earth's habitability through integrated system dynamics rather than separate disciplinary approaches.
- **Graph impact:** Connects ecological thinking with planetary science, climate studies, and astrobiology while inspiring interdisciplinary dialogue across natural sciences, philosophy, and environmental policy.

### Gorgias
- **Role:** source | **Domain:** philosophy | **Format:** dialogue
- **Path:** `knowledge/sources/philosophy-gorgias.md`
- **Curator:** shalom | **Tags:** rhetoric, dialectic, justice, virtue, soul, pleasure, good-and-evil
- **Author:** Plato
- **Origin:** ~380 BCE (ancient)
- **Tradition:** platonic
- **Related:** sources/philosophy-apology.md, sources/philosophy-euthyphro.md, collections/socrates-foundations.md, sources/cross-the-prophet.md, collections/cosmo-foundations.md
- **Gaps served:** Provides foundational examination of rhetoric's relationship to philosophy and establishes key Socratic paradoxes about ethics and justice.
- **Graph impact:** Connects ancient discussions of persuasion and politics to deeper questions of moral philosophy and the nature of the good life.

### Laws
- **Role:** source | **Domain:** philosophy | **Format:** dialogue
- **Path:** `knowledge/sources/philosophy-laws.md`
- **Curator:** shalom | **Tags:** political-philosophy, legal-theory, platonic-dialogue, governance, legislation, ancient-politics
- **Author:** Plato
- **Origin:** ~350 BCE (ancient)
- **Tradition:** platonic
- **Related:** sources/philosophy-apology.md, sources/philosophy-euthyphro.md, sources/philosophy-gorgias.md, sources/cross-the-prophet.md, references/ecology-gaia-hypothesis.md
- **Gaps served:** Provides Plato's mature practical vision of law and governance, bridging his earlier idealistic political philosophy with concrete legislative proposals.
- **Graph impact:** Connects ancient Greek political theory to later jurisprudence and offers a counterpoint to the Republic's philosopher-king model with detailed legal structures.

### Meno
- **Role:** source | **Domain:** philosophy | **Format:** dialogue
- **Path:** `knowledge/sources/philosophy-meno.md`
- **Curator:** shalom | **Tags:** virtue, knowledge, teachability, recollection, socratic-method, epistemology, ethics
- **Author:** Plato
- **Origin:** ~380 BCE (ancient)
- **Tradition:** platonic
- **Related:** sources/philosophy-euthyphro.md, sources/philosophy-gorgias.md, sources/philosophy-apology.md, sources/philosophy-laws.md, sources/cross-the-prophet.md
- **Gaps served:** Provides a foundational exploration of the relationship between knowledge, virtue, and education through dialectical inquiry.
- **Graph impact:** Connects ethical questions about virtue with epistemological theories of learning and innate knowledge, bridging moral philosophy and theory of knowledge.

### Phaedo
- **Role:** source | **Domain:** philosophy | **Format:** dialogue
- **Path:** `knowledge/sources/philosophy-phaedo.md`
- **Curator:** shalom | **Tags:** death, soul-body-separation, immortality, virtue, purification, philosophical-life
- **Author:** Plato
- **Origin:** ~380 BCE (ancient)
- **Tradition:** platonic
- **Related:** sources/philosophy-gorgias.md, sources/philosophy-meno.md, sources/philosophy-apology.md, sources/philosophy-euthyphro.md, sources/philosophy-laws.md
- **Gaps served:** Provides foundational arguments for soul-body dualism and the immortality of the soul within Western philosophical tradition.
- **Graph impact:** Enables connections between ancient metaphysics, ethics, religious thought, and later philosophical discussions of mind-body problems and personal identity.

### Phaedrus
- **Role:** source | **Domain:** philosophy | **Format:** dialogue
- **Path:** `knowledge/sources/philosophy-phaedrus.md`
- **Curator:** shalom | **Tags:** love, rhetoric, dialectic, soul, philosophy, beauty, discourse
- **Author:** Plato
- **Origin:** ~370 BCE (ancient)
- **Tradition:** platonic
- **Related:** sources/philosophy-gorgias.md, sources/philosophy-apology.md, collections/socrates-foundations.md, sources/philosophy-meno.md, sources/philosophy-phaedo.md
- **Gaps served:** Provides foundational exploration of the relationship between love, philosophy, and the craft of persuasive speech in classical thought.
- **Graph impact:** Connects ancient theories of love and beauty to dialectical method and establishes frameworks for understanding rhetoric's relationship to truth.

### Leaves of Grass
- **Role:** source | **Domain:** literature | **Format:** poetry
- **Path:** `knowledge/sources/literature-leaves-of-grass.md`
- **Curator:** shalom | **Tags:** american-poetry, transcendentalism, democracy, spirituality, nature, civil-war, individualism
- **Author:** Walt Whitman
- **Origin:** 1855 (modern)
- **Tradition:** transcendentalism
- **Related:** sources/cross-the-prophet.md, sources/philosophy-apology.md, sources/philosophy-gorgias.md, sources/philosophy-meno.md, sources/philosophy-phaedo.md
- **Gaps served:** Provides foundational American poetic voice that democratized literature and expressed spiritual philosophy through accessible verse.
- **Graph impact:** Connects American literary tradition with philosophical inquiry into democracy, spirituality, and human experience across cultures and disciplines.

### Symposium
- **Role:** source | **Domain:** philosophy | **Format:** dialogue
- **Path:** `knowledge/sources/philosophy-symposium.md`
- **Curator:** shalom | **Tags:** love, eros, philosophical-dialogue, ancient-greek, virtue, beauty, metaphysics
- **Author:** Plato
- **Origin:** ~385 BCE (ancient)
- **Tradition:** platonic
- **Related:** sources/philosophy-phaedrus.md, sources/philosophy-gorgias.md, sources/philosophy-meno.md, sources/philosophy-phaedo.md, sources/philosophy-apology.md
- **Gaps served:** Provides foundational Western philosophical treatment of love as both cosmic principle and human experience.
- **Graph impact:** Establishes connections between metaphysics, ethics, aesthetics, and psychology through the central concept of eros as ascending desire.

### Tao Te Ching
- **Role:** source | **Domain:** taoism | **Format:** scripture
- **Path:** `knowledge/sources/taoism-tao-te-ching.md`
- **Curator:** shalom | **Tags:** tao, wu-wei, non-action, emptiness, naturalness, virtue, harmony
- **Author:** Lao Tzu
- **Origin:** ~6th century BCE (ancient)
- **Tradition:** taoist
- **Related:** sources/philosophy-gorgias.md, sources/philosophy-meno.md, sources/philosophy-phaedo.md, sources/philosophy-symposium.md, sources/philosophy-apology.md
- **Gaps served:** Provides the essential philosophical foundation for understanding Taoist principles of natural action, emptiness, and spiritual governance.
- **Graph impact:** Enables dialogue between Eastern non-dualistic philosophy and Western thought, connecting concepts of natural action to contemporary discussions of ecology, leadership, and spiritual practice.

### The Republic
- **Role:** source | **Domain:** philosophy | **Format:** dialogue
- **Path:** `knowledge/sources/philosophy-the-republic.md`
- **Curator:** shalom | **Tags:** political-philosophy, metaphysics, justice, ideal-state, epistemology, ethics
- **Author:** Plato
- **Origin:** ~380 BCE (ancient)
- **Tradition:** platonism
- **Related:** sources/philosophy-euthyphro.md, sources/philosophy-meno.md, sources/philosophy-apology.md, sources/philosophy-gorgias.md, sources/philosophy-laws.md
- **Gaps served:** Provides the foundational Western philosophical treatment of justice, political organization, and the relationship between individual virtue and social order.
- **Graph impact:** Enables connections between political philosophy, epistemology, ethics, and metaphysics while establishing the framework for subsequent philosophical discourse on ideal societies and the nature of knowledge.

### Theaetetus
- **Role:** source | **Domain:** philosophy | **Format:** dialogue
- **Path:** `knowledge/sources/philosophy-theaetetus.md`
- **Curator:** shalom | **Tags:** epistemology, knowledge, socratic-method, dialectic, platonic-dialogue, ancient-philosophy
- **Author:** Plato
- **Origin:** ~390 BCE (ancient)
- **Tradition:** platonic
- **Related:** sources/philosophy-meno.md, sources/philosophy-apology.md, sources/philosophy-gorgias.md, sources/philosophy-phaedrus.md, sources/philosophy-euthyphro.md
- **Gaps served:** Provides foundational exploration of epistemological questions about the nature and definition of knowledge in ancient philosophical tradition.
- **Graph impact:** Connects Socratic methodology with later Platonic metaphysics and establishes key epistemological frameworks that influenced subsequent Western philosophical discourse.

### Timaeus
- **Role:** source | **Domain:** philosophy | **Format:** dialogue
- **Path:** `knowledge/sources/philosophy-timaeus.md`
- **Curator:** shalom | **Tags:** cosmology, natural-philosophy, creation-myth, mathematics, ancient-science, metaphysics
- **Author:** Plato
- **Origin:** ~360 BCE (ancient)
- **Tradition:** platonism
- **Related:** sources/philosophy-the-republic.md, sources/philosophy-symposium.md, sources/philosophy-apology.md, sources/philosophy-gorgias.md, sources/philosophy-meno.md
- **Gaps served:** Provides Plato's systematic account of cosmology and natural philosophy, bridging metaphysical theory with physical speculation.
- **Graph impact:** Connects ancient Greek philosophy to medieval Christian and Islamic cosmology, influencing centuries of natural philosophy and theology.
...
- **Tradition:** mahayana
- **Related:** sources/buddhism-the-dhammapada.md, sources/taoism-tao-te-ching.md, sources/philosophy-apology.md, sources/philosophy-gorgias.md, sources/philosophy-meno.md
- **Gaps served:** Provides the essential distillation of Prajnaparamita wisdom literature on emptiness and non-dual awareness.
- **Graph impact:** Connects core Buddhist metaphysics with contemplative practice and enables dialogue between emptiness philosophy and contemporary non-dual teachings.
